...
const BLOG_DATA: Record<string, { title: string; description: string; image: string }> = {
  ...
  "connecticut-is-1-in-the-us-for-lgbtq-real-estate-searches-here-s-why": {
    ...
    description: "Google Trends data shows Connecticut ranks #1 nationally for LGBTQ real estate search volume. Here's what's driving it.",
    image: `${BASE_DOMAIN}/ct_lgbtq_places.png`,
  },
  ...
  "how-to-choose-a-gay-friendly-realtor-2026-guide": {
    ...
    description: "Not every realtor understands LGBTQ+ buyers. Learn what questions to ask, what credentials matter, and how to find a truly affirming gay realtor in Connecticut.",
    image: `${BASE_DOMAIN}/gay_realtor_guide.png`,
  },
  "lgbtq-first-time-home-buyer-guide-connecticut-edition": {
    title: "LGBTQ+ First-Time Home Buyer Guide (Connecticut Edition)",
    description: "A complete guide for LGBTQ+ first-time home buyers in Connecticut — from pre-approval to closing, with CT programs, gay realtors, and legal protections.",
    image: `${BASE_DOMAIN}/lgbtq_first_time_buyer.png`,
  },
